...
//E:\d2\www\2013Proj\soft\draft\0035Rescuer=28.01.16\code\TimeCtl\Metronome_lpc2148.cpp
//E:\d2\www\2013Proj\soft\bank\Standard\Strd0\TimeCtl\Metronome_lpc2148.cpp
...
AbstractMetronome& Metronome::operator = (unsigned int uS)
{
	if(isStarted == false)
	{
		*matchReg = GetMatchVal(uS);
		*intIdReg = matchIdBit;
		isStarted = true;
	}
	return *this;
...
bool Metronome::operator > (unsigned int uS) 
{
		return  !IsOver();
}
